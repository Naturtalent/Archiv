...
/**
 * This is the item provider adapter for a {@link it.naturtalent.archiv.model.archiv.Archiv} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchivItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public ArchivItemProvider(AdapterFactory adapterFactory)
	{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Archiv_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Archiv_name_feature", "_UI_Archiv_type"),
				 ArchivPackage.Literals.ARCHIV__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAdressePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Archiv_adresse_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Archiv_adresse_feature", "_UI_Archiv_type"),
				 ArchivPackage.Literals.ARCHIV__ADRESSE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(ArchivPackage.Literals.ARCHIV__ORDNER);
		}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(Archiv.class))
		{
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(ArchivPackage.Literals.ARCHIV__ORDNER,
				 ArchivFactory.eINSTANCE.createOrdner()));
	}
