...
public class ArchivePackageImpl extends EPackageImpl implements ArchivePackage
{
	 ...
	 * @see archive.ArchivePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getOrdner_Archiv()
	{
		return (EReference)ordnerEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getArchiv_Location()
	{
	...
	public void createPackageContents()
	{
		...
		createEReference(ordnerEClass, ORDNER__ARCHIV);

		archivEClass = createEClass(ARCHIV);
		createEAttribute(archivEClass, ARCHIV__NAME);
		createEReference(archivEClass, ARCHIV__LOCATION);
	...
	public void initializePackageContents()
	{
		...
		initEReference(getOrdner_Archiv(), this.getArchiv(), null, "archiv", null, 0, 1, Ordner.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getArchiv_Location(), theLocationPackage.getAdresse(), null, "location", null, 0, 1, Archiv.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
