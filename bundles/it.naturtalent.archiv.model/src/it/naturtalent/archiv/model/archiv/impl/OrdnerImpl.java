 ...
 * </p>
 * <ul>
 *   <li>{@link it.naturtalent.archiv.model.archiv.impl.OrdnerImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link it.naturtalent.archiv.model.archiv.impl.OrdnerImpl#getRegisters <em>Registers</em>}</li>
 *   <li>{@link it.naturtalent.archiv.model.archiv.impl.OrdnerImpl#getRegisterType <em>Register Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrdnerImpl extends MinimalEObjectImpl.Container implements Ordner
{
	...
	{
		return ArchivPackage.Literals.ORDNER;
	}
	...
	public void setLabel(String newLabel)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchivPackage.ORDNER__LABEL, oldLabel, label));
	}
	...
	public EList<Register> getRegisters()
	{
		if (registers == null)
		{
			registers = new EObjectContainmentEList<Register>(Register.class, this, ArchivPackage.ORDNER__REGISTERS);
		}
		return registers;
	}
	...
	public void setRegisterType(RegisterType newRegisterType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchivPackage.ORDNER__REGISTER_TYPE, oldRegisterType, registerType));
	}
