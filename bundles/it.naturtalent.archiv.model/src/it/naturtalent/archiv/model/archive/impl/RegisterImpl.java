 ...
 * </p>
 * <ul>
 *   <li>{@link it.naturtalent.archiv.model.archive.impl.RegisterImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link it.naturtalent.archiv.model.archive.impl.RegisterImpl#getProjectID <em>Project ID</em>}</li>
 *   <li>{@link it.naturtalent.archiv.model.archive.impl.RegisterImpl#getCounter <em>Counter</em>}</li>
 *   <li>{@link it.naturtalent.archiv.model.archive.impl.RegisterImpl#getNumericData <em>Numeric Data</em>}</li>
 *   <li>{@link it.naturtalent.archiv.model.archive.impl.RegisterImpl#getAlphaData <em>Alpha Data</em>}</li>
 * </ul>
 *
 * @generated
 */
		...
		if (StringUtils.isEmpty(getLabel())) { 
			if (chain != null) {
				chain.add(new BasicDiagnostic(Diagnostic.ERROR,
					...
					ArchiveValidator.REGISTER__HAS_NAME, "Schedule braucht einen Namen", //$NON-NLS-1$
