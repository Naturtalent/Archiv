...
public class ArchiveAdapterFactory extends AdapterFactoryImpl
{
	...
	/**
	 * Creates a new adapter for an object of class '{@link it.naturtalent.archiv.model.archive.Register <em>Register</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link it.naturtalent.archiv.model.archive.Ordner <em>Ordner</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
