...
/**
 * Liefert den modifizierten MultiReferenceSWTRenderer der in einem Archiv gespeicherten Ordner
 * 
 * @author dieter
 *
 */
public class ArchivRendererService extends MultiReferenceSWTRendererService
{
			...
			ViewModelContext viewModelContext)
	{
		...
		if (ArchivPackage.eINSTANCE.getArchiv_Ordner().equals(feature))
		{
