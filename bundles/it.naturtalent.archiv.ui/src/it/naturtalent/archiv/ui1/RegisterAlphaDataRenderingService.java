 ...
 * 
 */
public class RegisterAlphaDataRenderingService
		implements EMFFormsDIRendererService<VControl>
{
			...
			ViewModelContext viewModelContext)
	{
		...
		if (ArchivePackage.eINSTANCE.getRegister_NumericData().equals(eStructuralFeature))
		{
			return 20.0;			
		}
	...
	{
		return RegisterNumericDataRendering.class;	
	}
